...
// Quadrant color gradients (dark to light) for sequential piece placement
export const QUADRANT_GRADIENTS = {
  FORM: ['#1244C5', '#3544E0', '#5354ED', '#5E5BFF', '#7496E9', '#87BEF7', '#C0E5EB'],
  MOTION: ['#193E18', '#0A6439', '#169B2F', '#00A650', '#00DE8C', '#87E8B5', '#C9F9DF'],
  EXPRESSION: ['#532ACC', '#923CFF', '#8E34FE', '#746DD8', '#B4ABFA', '#C4ADFD', '#E0DEF8'],
  FUNCTION: ['#AF0C21', '#E91D26', '#FB07AA', '#FE93F1', '#FEA1E6', '#FFB5FA', '#FFD5FF'],
} as const;
...
export const getSequentialColor = (mode: DesignMode, attachmentIndex: number): string => {
  ...
  // If index is beyond gradient length, use the lightest color
  if (attachmentIndex >= gradient.length) {
    return gradient[gradient.length - 1];
  }
  return gradient[attachmentIndex];
};
